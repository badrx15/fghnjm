...
languages = {
    ...
    "es": {
        "help": "⏩⏩¡Bienvenido a TikTok Video Installer!\n⏩⏩¡Para usar, simplemente envía el enlace del video de TikTok!\n⏩⏩Soporte tectino @monoloc00",
        ...
        "views": "views",
        "nickname": "nickname",
        "large_for_tg": "El video es demasiado grande para telegram (límite de 20 MB), pero puede descargar el video sin problemas pronto en nuestra web",
    },
    "fr": {
        "help": "Téléchargez des vidéos ou des images depuis tiktok easy\nEnvoyez-moi un lien de vidéo.\nSi vous voyez des bugs, envoyez-moi un message @monoloc00",
    ...
    "ar": {
        "help": "قم بتنزيل الفيديو أو الصور من tiktok easy \ n أرسل لي رابط فيديو. \ n إذا رأيت أخطاء برسالة لي @monoloc00",
    ...
    "he": {
        "help": "הורד סרטון או תמונות מ-tiktok easy\nשלח לי קישור לסרטון.\nאם אתה רואה באגים שלח לי הודעה @monoloc00",
